...
export default class CountryPicker extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      modalVisible: false,
      selectedCountry: this.props.selectedCountry || Country.getAll(this.props.country)[0],
    };
          ...
          >
            ...
            <View style={styles.mainBox}>
              <Picker
                ...
                mode="dialog"
              >
                {Country.getAll(this.props.country).map((country, index) => this.renderItem(country, index))}
              </Picker>
            </View>
          </View>
        </View>
