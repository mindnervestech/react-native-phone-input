...
export default class PhoneInput extends Component {
  ...
  constructor(props, context) {
    ...
    const countryData = PhoneNumber.getCountryDataByCode(initialCountry, this.props.country);
  ...
  getPickerData() {
    return PhoneNumber.getAllCountries(this.props.country).map((country, index) => ({
      key: index,
  ...
  getCountryCode() {
    const countryData = PhoneNumber.getCountryDataByCode(this.state.iso2, this.props.country);
    return countryData.dialCode;
  }

  getAllCountries() {
    return PhoneNumber.getAllCountries(this.props.country);
  }
  ...
  getDialCode() {
    return PhoneNumber.getDialCode(this.state.formattedNumber, this.props.country);
  }
  ...
  selectCountry(iso2) {
    if (this.state.iso2 !== iso2) {
      const countryData = PhoneNumber.getCountryDataByCode(iso2, this.props.country);
      if (countryData) {
        this.setState(
          {
            iso2,
  ...
  updateFlagAndFormatNumber(number, actionAfterSetState = null) {
    ...
    if (number) {
      ...
      iso2 = PhoneNumber.getCountryCodeOfNumber(phoneNumber, this.props.country);
    }
